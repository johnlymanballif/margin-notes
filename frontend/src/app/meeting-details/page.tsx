...
import { meetingCache } from "@/lib/cache";
...
function MeetingDetailsContent() {
  ...
  const fetchMeetingDetails = useCallback(async () => {
    ...
    try {
      ...
      if (cached) {
        console.log('📦 Using cached meeting details for:', meetingId);
        setMeetingDetails(cached);
        setCurrentMeeting({ id: cached.id, title: cached.title });
        return;
      }
      ...
      meetingCache.set(meetingId, data, 5 * 60 * 1000);
