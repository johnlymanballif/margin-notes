...
export interface Folder {
  ...
  name: string;
  color?: string; // Hex color code for visual organization
  parent_id?: string; // For nested folders (NULL for root folders)
  created_at?: string;
  updated_at?: string;
}
...
export interface Meeting {
  ...
  title: string;
  folder_id?: string;
  folder_name?: string; // Denormalized for quick access
  tags?: Tag[]; // Array of tags associated with this meeting
  created_at?: string;
  updated_at?: string;
}
