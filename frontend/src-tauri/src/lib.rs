...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Speaker and Company commands
            database::commands::get_speakers,
            database::commands::create_speaker,
            database::commands::update_speaker,
            database::commands::delete_speaker,
            database::commands::get_companies,
            database::commands::create_company,
            database::commands::update_company,
            database::commands::delete_company,
            database::commands::update_transcript_speaker,
            // Tag commands
            database::commands::get_all_tags,
            database::commands::create_tag,
            database::commands::update_tag,
            database::commands::delete_tag,
            database::commands::get_meeting_tags,
            database::commands::add_tag_to_meeting,
            database::commands::remove_tag_from_meeting,
            database::commands::set_meeting_tags,
            // Folder commands
            database::commands::get_all_folders,
            database::commands::get_root_folders,
            database::commands::create_folder,
            database::commands::update_folder,
            database::commands::delete_folder,
            database::commands::update_meeting_folder,
            database::commands::get_master_prompt,
            database::commands::save_master_prompt,
            database::commands::process_uploaded_audio,
